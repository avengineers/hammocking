...
class MOCK_SECTION:
   ...
   def add_function(self, type: str, name: str, params: List[str]) -> None:  # TODO: proper parameter list
   ...
   def _func_impl(self, f: Tuple[str, str, List[str]]) -> str:
      ...
      func_decl = f"{return_type} {name}(" + ("void" if len(params) == 0 else ", ".join(params)) + ")\n"
